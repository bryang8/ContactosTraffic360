...
public class PhoneController {
    ...
    public static PhoneController getInstance() {
        return instance == null ? new PhoneController() : instance;
    }

    public List<Phone> phoneList(Integer idContact) {
        ResultSet rs = Conexion.getInstancia().obtenerConsulta("SELECT * from phone WHERE idContact = " + idContact + ";");
    ...
    public void add(Phone phone) {
        Conexion.getInstancia().ejecutarConsulta("INSERT INTO phone values(null," + phone.getNumber() + "," + phone.getIdContact() + ");");
    }

    public void delete(Integer idPhone) {
        Conexion.getInstancia().ejecutarConsulta("DELETE FROM phone WHERE idPhone=" + idPhone);
    }

    public void edit(Phone phone) {
        Conexion.getInstancia().ejecutarConsulta("UPDATE phone SET number = " + phone.getNumber() + " WHERE idPhone = " + phone.getIdPhone());
    }
