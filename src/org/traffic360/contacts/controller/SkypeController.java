...
public class SkypeController {
    ...
    public static SkypeController getInstance() {
        return instance == null ? new SkypeController() : instance;
    }

    public List<Skype> skypeList(Integer idContact) {
        ResultSet rs = Conexion.getInstancia().obtenerConsulta("SELECT * from skype WHERE idContact = " + idContact + ";");
    ...
    public void add(Skype skype) {
        Conexion.getInstancia().ejecutarConsulta("INSERT INTO skype values(null,'" + skype.getSkype() + "'," + skype.getIdContact() + ");");
    }

    public void delete(Integer idSkype) {
        Conexion.getInstancia().ejecutarConsulta("DELETE FROM skype WHERE idSkype= " + idSkype);
    }

    public void edit(Skype skype) {
        Conexion.getInstancia().ejecutarConsulta("UPDATE skype SET skype = '" + skype.getSkype() + "' WHERE idSkype = " + skype.getIdSkype() + " ;");
    }
